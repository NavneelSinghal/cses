...
int main() {
    ...
    for (int _test = 1; _test <= _tests; ++_test) {
        ...
        constexpr Node id_node{-1, -1, 0};
        constexpr auto make_node = [](Base b, int i) -> Node {
            return {i, i + 1, b};
        };
        ...
        constexpr Update id_update = {0, 0};
        constexpr auto apply_update = [](const Update& u,
                                         const Node& n) -> Node {
            return {n.l, n.r,
                    n.sum + u.x * (n.r - n.l) * (n.l + n.r - 1) / 2 +
                        u.y * (n.r - n.l)};
        };
