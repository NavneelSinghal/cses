...
int main() {
    ...
    for (int _test = 1; _test <= _tests; ++_test) {
        ...
        cin >> n;
        vector<mint> dp(n + 1);
        // https://projecteuclid.org/journals/annals-of-mathematical-statistics/volume-36/issue-2/A-Recurrence-for-Permutations-without-Rising-or-Falling-Successions/10.1214/aoms/1177700181.full
        // plug in t = 0
        for (int i = 0; i <= n; ++i) {
            if (i <= 1)
                dp[i] = 1;
