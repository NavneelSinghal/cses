...
int main() {
    ...
    for (int _test = 1; _test <= _tests; ++_test) {
        // cout << "Case #" << _test << ": ";
        /*
           let's do this in reverse order. for sticks a and b that are joined,
           make (a concat b) their parent. the contribution of a stick is the
           depth in this tree, so we just need a huffman encoding.
           */
        int n, x;
        cin >> x >> n;
        vector<int> a(n);
